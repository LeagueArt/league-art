...
export const SITE = {
  ...
  seoTitle: "리그아트 | 강남 미술유학·패션유학 포트폴리오 & 메이킹 전문",
  seoDescription:
    "파슨스 수석 졸업 원장·CSM 수석 출신 지도진 직강 | 명품 브랜드 현역 크리에이티브 디렉터·뉴욕 파슨스 패션쇼 심사위원 | 1:4 소수정예 | 해외 미대·패션스쿨 입시 포트폴리오·장학금 전략·의상 메이킹 전문 | 무료 포트폴리오 리뷰",
  keywords: [
    "패션유학",
    "패션유학학원",
    "강남 패션유학",
